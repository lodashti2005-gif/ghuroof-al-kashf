...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "ورا السالفة — شلون تلعب لعبة القضايا الغامضة" },
      {
        name: "description",
        content:
          "ورا السالفة: لعبة تحقيق جماعية بالعربي. اعرف شلون تلعب — اختاروا القضية، ادخلوا مع ربعكم، فتشوا مسرح الجريمة، استجوبوا المشتبهين واكشفوا الحقيقة.",
      },
      { property: "og:title", content: "ورا السالفة — مو كل واحد يقول الحقيقة" },
      {
        property: "og:description",
        content: "شلون تلعب ورا السالفة: أدوار، أدلة مخفية، استجواب، واتهام نهائي.",
      },
